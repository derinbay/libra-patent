				...
				<div class="container">
					<div class="banner_content text-center">
						<div class="page_link">
							...
							<a href="hukuki-islemler.php">Hukuki İşlemler</a>
						</div>
						<h2>Hukuki İşlemler</h2>
					</div>
				</div>
            </div>
        </section>
        ...
        <section class="text_members_area p_120">
        	<div class="container">
        		<div class="main_title">
        			...
        			<br><p><h3>Fikri ve Sınai Haklarınızı etkin olarak koruyabilmek için hukuki olarak neler yapabilsiniz?</h3></p>
        		</div>
        		<div class="member_slider owl-carousel">
        			<div class="item">
        				<div class="member_item">
        					<h4>İhtarname göndererek ihlalin durdurulmasını talep edebilirsiniz.</h4>
        				</div>
        			</div>
        			<div class="item">
        				<div class="member_item">
        					<h4>Mahkemelerde dava açabilirsiniz.</h4>
        				</div>
        			</div>
        			<div class="item">
        				<div class="member_item">
        					<h4>Mahkeme ya da polis kanalıyla taklit ürünleri toplatabilirsiniz.</h4>
        				</div>
        			</div>
        			<div class="item">
        				<div class="member_item">
        					<h4>Gümrüklerde gerekli başvuruları yaparak taklit ürünlerin giriş ve çıkışlarını engelleyebilirsiniz. </h4>
        				</div>
        			</div>
        			<div class="item">
        				<div class="member_item">
        					<h4>Taklit ve ihlalin tespiti amacıyla saha araştırması ve incelenmesi yapabilirsiniz.</h4>
        				</div>
        			</div>
        		</div>
        	</div>
