...
<section class="home_gallery_area p_120">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h3 align="center"class="text-heading title_color">MARKA İŞLEMLERİ</h3>
				...
				<p>Bu doğrultuda markanızın korumasının eksiksiz bir şekilde sağlanabilmesi için;</p>
				<ul>
                    <li>öncelikle çalışma alanınız için gerekli sınıflar belirlenmekte,</li>
				...
				<p>Yenileme işlemi koruma süresi bitiminden 6 ay önceden başlayarak korumanın son gününe kadar normal ücretlerle yapılabilmektedir.</p>
				<p>Normal süresi içerisinde yenilenmeyen markalar ilave 6 aylık sürede cezalı olarak yenilenebilmektedir. Bu süre zarfında da marka yenilemesi yapılmadığı taktirde marka iptal olmakta ve diğer kişi ya da kuruluşlar adına tescil edilebilmektedir.</p>
				<p>Libra Patent tarafından marka yenileme işlemleriniz Türk Patent ve Marka Kurumu nezrinde çok hızlı bir şekilde tamamlanabilmektedir.</p>
				<p>Marka yenileme işlemi öncesinde tarafımızca;</p>
				<ul>
				...
				<h3 class="text-heading title_color">İlan Edilen Markalara İtiraz</h3>
				<p>Türk Patent ve Marka Kurumu tarafından yapılan inceleme sonrasında kabul edilen marka başvuruları Resmi Marka Bülteni ‘nde 2 ay süreyle ilan edilmekte ve ilan süresi içerisinde, diğer kişi ve kuruluşların ilgili markalara itiraz edebilme hakları bulunmaktadır.</p>
				<p>Günümüzde Türk Patent ve Marka Kurumu tarafından marka başvurularının genel konseptte incelendiği ve birebir aynı markalar bulunmadığı sürece marka başvurularının kabul edilerek yayınlandığı görülmektedir. Bu nedenle markalarınıza çok yakın ve benzer olan markaların tescil edilmemesi için, benzer markaların takip edilmesi ve yayınlanan benzer markaların ilanlarına 2 aylık itiraz süresi içerisinde itiraz edilmesi gerekmektedir. </p>
				...
				<p>Libra Patent olarak başvurusu yapılan ve tescilli tüm markalarınızla ilgili olarak sicilde güncellenmesi gereken;</p>
				<ul>
				...
				<p>Bu markaların ekonomik değerleri de çoğu zaman şirket değerlendirmelerinin dahi önüne geçmiş durumdadır ve tüketiciler için sıkı bir bağlılık oluşturmuştur. Bu nedenle bir marka özel korunan markalar statüsünde yani tanınmış marka olarak korunması çok önemlidir.</p>
				<p>Aksi takdirde kötü niyetli 3. Kişi ya da kuruluşlar bu markaların tanınmışlığından yararlanarak haksız kazanç elde edebilecek ve marka karakterine ve kalite algısına zarar verebilecektir.</p>
				<p>Libra Patent marka tescili ve tanınmışlık analizi ve uygun görülen markaların tanınmış marka başvuruları için yardımcı olmaktan memnuniyet duyacaktır.</p>
				<h3 class="text-heading title_color">Marka İşlemleri İçin Gerekli Evraklar</h3>
				...
				<ul>
					...
					<p><h5><strong><u>Devir ve Lisans İşlemleri;</u></strong></h5></p>
				<ul>
					<li>Noter tasdikli devir veya lisans sözleşmesi</li>
				</ul>
				<p><h5><strong><u>Unvan Değişikliği ve Birleşme İşlemleri;</u></strong></h5></p>
				<ul>
					<li>Değişikliği gösteren eden Ticaret Sicil Gazetesi Aslı</li>
				</ul>
				<p><h5><strong><u>Adres Değişikliği İşlemleri;</u></strong></h5></p>
				<ul>
					<li>Yeni adres bilgisi yeterli olup, herhangi bir doküman ihtiyacı yoktur.</li>
				</ul>
				<h3 class="text-heading title_color">YURT DIŞI İŞLEMLER</h3>
				<p>Marka tescillerinde ülkesellik prensibi bulunmaktadır. Yani markalar sadece tescil edildikleri ülkelerde geçerlidir. Markanın yurt dışındaki ülkelerde kullanımı ve korunması için talep edilen ülkelerde de tescil işleminin tamamlanması gerekmektedir.</p>
				...
				<h3 class="text-heading title_color">RÜÇHAN HAKKI</h3>
				<p>Rüçhan hakkı kısaca “öncelik hakkı” olarak ifade edilebilmektedir. Buna göre Paris Sözleşmesine üye ülkelerin herhangi birinde yapılan marka başvurusu için, 6 ay içerisinde başka bir ülkede yapılan başvuruya öncelik tescil edebilmektedir. Bunun için ikinci yapılan başvuruda Rüçhan ücretinin ödenmesi ve Rüçhan hakkının talep edilmesi gerekmektedir.</p>
				<p>Buna göre Türkiye 7de yapılan başvuruların 6 ay içerisinde yurt dışında da yapılması durumunda öncelik hakkından faydalanabilmekte ve koruma süresini daha erkene çekebilirsiniz.</p>
				<h3 class="text-heading title_color">TEŞVİKLER</h3>
				<p>Ülkemizde marka başvuruları özellikle yurt dışı marka tescil işlemleri çeşitli şekillerde teşvik edilebilmekte ve geri ödemeler alınabilmektedir.</p>
				<ul>
					<li>Turquality</li>
					<li>Kosgeb</li>
